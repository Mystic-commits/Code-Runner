...
export const CODE_SNIPPETS = {
  ...
  java: `\npublic class HelloWorld {\n\tpublic static void main(String[] args) {\n\t\tSystem.out.println("Hiii Alex, Yug This side I hope you enjoy this project and find good use for it");\n\t}\n}\n`,
  csharp:
    'using System;\n\nnamespace HelloWorld\n{\n\tclass Hello { \n\t\tstatic void Main(string[] args) {\n\t\t\tConsole.WriteLine("Hiii Alex, Yug This side I hope you enjoy this project and find good use for it");\n\t\t}\n\t}\n}\n',
